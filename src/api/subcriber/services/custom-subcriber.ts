...
export default ({ strapi }) => ({
    ...
    async sendConfirmationEmail(subscriber) {
        ...
        const confirmationLink = `${frontendUrl}/subscribers/confirmation/index.html?token=${confirmationToken}`;
        const unsubscribeLink = `${frontendUrl}/subscribers/unsubscribe/index.html?email=${encodeURIComponent(email)}`;
